...
import { EmpetyMemories } from './components/EmpetyMemories'
    ...
    <div className='flex flex-col gap-10 p-8'>
      {memories.map(memory =>(
        <div key={memory.id} className='space-y-4'>
          <time className='flex items-center gap-2 text-sm -ml-8 text-gray-100 before:w-5 before:h-px before:bg-gray-50 '>
